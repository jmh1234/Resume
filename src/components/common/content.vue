          ...
          <ol class="item-project">
            <li class="project-1">
              ...
              <ol>
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">交易所后端</h3>
                    <div class="div-item">
                ...
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">交易所前端</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
                ...
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">以太坊智能合约开发</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
                      <p class="item-project-des">
                ...
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">交易所APP开发</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
            ...
            <li class="project-1">
              ...
              <ol>
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">钱包APP</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
                      <p class="item-project-des">
            ...
            <li class="project-1">
              ...
              <ol>
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">后台开发(PHP)</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
                      <p class="item-project-des">
          ...
          <ol class="item-project">
            <li class="project-1">
              ...
              <ol>
                <li class="project-2">
                  <div class="item-bd">
                    <h3 class="project-name">伴知旅行Android APP</h3>
                    <div class="div-item">
                      <h3 class="project-des">【项目简介】</h3>
                      <p class="item-project-des">
    ...
    $(document).ready(function () {
      if ($('ol:first').css('list-style-type') === 'none') {
        $('ol ol').each(function (i, ol) {
          ol = $(ol);
          let level1 = ol.closest('li').index() + 1;
          ol.children('li').each(function (i, li) {
            li = $(li);
            let level2 = level1 + '.' + (li.index() + 1);
